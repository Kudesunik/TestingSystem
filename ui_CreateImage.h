...
public:
    ...
    void setupUi(QDialog *CreateImage)
    {
        ...
        label_4->setGeometry(QRect(10, 160, 111, 31));
        ...
        label_5->setGeometry(QRect(10, 200, 111, 31));
